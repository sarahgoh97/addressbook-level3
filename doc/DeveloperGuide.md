...
`* * *` | user | view a person in the address book | contact the person with their non-private contact details
`* *` | user | delete all persons in the address book | have a clean address book
